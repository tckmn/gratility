...
export class Frontend {
    ...
    public constructor(public readonly backend: Backend,
                       toolcont: HTMLElement | undefined,
                       toolsaved: string | undefined,
                       btns: Array<HTMLElement>,
                       popups: Array<HTMLElement>,
                       states: Array<HTMLElement>) {
